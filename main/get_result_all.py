...
data_processed_validate_1 = pd.read_csv('{}/get_last_features.csv'.format(data_path_valid_1))
data_processed_validate_2 = pd.read_csv('{}/get_last_features.csv'.format(data_path_valid_2))
data_processed_validate_3 = pd.read_csv('{}/get_last_features.csv'.format(data_path_valid_3))
data_processed_validate_4 = pd.read_csv('{}/get_last_features.csv'.format(data_path_valid_4))
